...
namespace Domain.Entities
{
    public class Book
    {
        ...
        [DataType(DataType.MultilineText)]
        [Display(Name = "ISBN")]
        [Required(ErrorMessage = "Пожалуйста, введите код книги")]
        ...
        [Required(ErrorMessage = "Пожалуйста, введите количество страниц в книге")]
        public int Pages { get; set; }

        [Display(Name = "id Издателя")]
        [Required(ErrorMessage = "Пожалуйста, введите id издателя")]
